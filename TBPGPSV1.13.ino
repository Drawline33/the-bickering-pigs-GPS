//This file is a mixture of 3 or more examples combined into one you will need the following required files
// REQUIRES the following Arduino libraries:
// - DHT Sensor Library: https://github.com/adafruit/DHT-sensor-library
// - Adafruit Unified Sensor Lib: https://github.com/adafruit/Adafruit_Sensor
// -TintGPS++ can be found https://github.com/mikalhart/TinyGPSPlus
// -MCUFRIEND_kbv can be found https://github.com/prenticedavid/MCUFRIEND_kbv
// -SdFat can be found https://github.com/greiman/SdFat 
...
#define DHTPIN 23 //define your DHT switch pin.
#define BLACK   0x0000
#define BLUE    0x001F
#define RED     0xF800
#define GREEN   0x07E0
...
Image images[] = {
  ...
  {"/Icons/image1.bmp", 10, 20},  // sat count at (100, 50)
...
void setup(){
  ...
  if (myFile) {
   ...
   // connect gps sensor
    ...
    tft.setCursor(63, 20);
    tft.print("The Bickering Pigs GPS v1.13");
...
void tempRead(){
  ...
  tft.setTextColor(BLACK, WHITE);
    ...
    //location of humidity value print
